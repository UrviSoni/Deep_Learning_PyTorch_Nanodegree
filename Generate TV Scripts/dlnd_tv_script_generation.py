...
# **Answer:** Through the course material regarding embedding, I noticed that typical embedding dimensions are around 200 - 300 in size.
# 
# Also, reading from this resource:-
# 
...
# 
# * sequence_length = 10, batch_size = 128, learning_rate = 0.001, embedding_dim = 200, hidden_dim = 250, n_layers = 2 Started with: Training for 10 epoch(s)... Epoch: 1/10 Loss: 4.949757320165634 ... Epoch: 4/10 Loss: 3.5788419675827026 ... Epoch: 7/10 Loss: 3.329745846748352 ...
# 
